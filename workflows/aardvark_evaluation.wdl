...
workflow AardvarkEvaluation {
    ...
    meta {
        description: "Evaluate small variants using Aardvark. Follows the same pattern as happy_evaluation.wdl. More information at [https://github.com/vgteam/vg_wdl/tree/master#aardvark-workflow](https://github.com/vgteam/vg_wdl/tree/master#aardvark-workflow)."
    }
